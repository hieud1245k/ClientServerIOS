...
class QRViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        guard let qrURLImage = URL(string: address)?.qrImage(using: UIColor.black) else { return }
        imgQR.image = qrURLImage
        imgQR.layer.borderColor = UIColor.gray.cgColor
        imgQR.layer.borderWidth = 1
    }
}
